...
class BookingDtoTest {
    ...
    void testBookingDto() throws Exception {
        ...
        assertThat(result).extractingJsonPathStringValue("$.booker.name").isEqualTo("Puka");
        assertThat(result).extractingJsonPathStringValue("$.booker.email").isEqualTo("Puka@akup.ru");
