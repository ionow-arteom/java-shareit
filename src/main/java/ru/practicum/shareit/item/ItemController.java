...
public class ItemController {
    ...
    @PostMapping
    public ResponseEntity<ItemDto> add(@RequestHeader("X-Sharer-User-Id") int userId, @Valid @RequestBody ItemDto itemDto) {
    ...
    @PatchMapping("/{itemId}")
    public ResponseEntity<ItemDto> edit(@RequestHeader("X-Sharer-User-Id") int userId, @PathVariable int itemId, @Valid @RequestBody ItemDto itemDto) {
    ...
    @GetMapping("/{itemId}")
    public ResponseEntity<ItemDto> get(@PathVariable int itemId) {
