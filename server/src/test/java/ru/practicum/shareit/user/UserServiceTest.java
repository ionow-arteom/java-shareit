...
class UserServiceTest {
    ...
    void addUser() {
        ...
        UserDto userDtoTest = userService.add(firstUserDto);
    ...
    void updateUser() {
        ...
        UserDto userDtoUpdated = userService.update(firstUserDto, 1L);
    ...
    void updateUser_wrongEmail() {
        ...
        assertThrows(EmailExistException.class, () -> userService.update(firstUserDto, 2L));
    }
