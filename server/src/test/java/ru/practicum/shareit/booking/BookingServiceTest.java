...
public class BookingServiceTest {
    ...
    void  addBooking() {
        ...
        BookingOutDto bookingOutDtoTest = bookingService.add(bookingDto, anyLong());
    ...
    void  addBookingWrongOwner() {
        ...
        assertThrows(NotFoundException.class, () -> bookingService.add(bookingDto, anyLong()));
    }
    ...
    void  addBookingItemBooked() {
        ...
        when(userRepository.existsById(anyLong())).thenReturn(true);
        when(userRepository.findById(anyLong())).thenReturn(Optional.of(secondUser));
        assertThrows(ValidationException.class, () -> bookingService.add(bookingDto, anyLong()));
    }
    ...
    void  approveBooking() {
        ...
        bookingOutDtoTest = bookingService.approve(firstUser.getId(), item.getId(), true);
        assertEquals(bookingOutDtoTest.getStatus(), Status.APPROVED);
        bookingOutDtoTest = bookingService.approve(firstUser.getId(), item.getId(), false);
    ...
    void  approveBookingWrongUser() {
        ...
        when(bookingRepository.findById(anyLong())).thenReturn(Optional.of(secondBooking));
        when(bookingRepository.save(any(Booking.class))).thenReturn(secondBooking);
        assertThrows(NotFoundException.class, () -> bookingService.approve(secondUser.getId(), item.getId(), true));
    }
    ...
    void  approveBookingWrongStatus() {
        ...
        when(bookingRepository.save(any(Booking.class))).thenReturn(firstBooking);
        assertThrows(ValidationException.class, () -> bookingService.approve(firstUser.getId(), item.getId(), true));
    }
    ...
    void  getBookingById() {
        ...
        when(bookingRepository.findById(anyLong())).thenReturn(Optional.of(firstBooking));
        when(userRepository.existsById(anyLong())).thenReturn(true);
        BookingOutDto bookingOutDtoTest = bookingService.getById(firstUser.getId(), firstBooking.getId());
        assertEquals(bookingOutDtoTest.getItem(), itemDto);
        assertEquals(bookingOutDtoTest.getStatus(), firstBooking.getStatus());
    ...
    void  getBookingByIdError() {
        ...
        when(bookingRepository.findById(anyLong())).thenReturn(Optional.of(firstBooking));
        when(userRepository.existsById(anyLong())).thenReturn(true);
        assertThrows(NotFoundException.class, () -> bookingService.getById(2L, firstBooking.getId()));
    }
